      ...
      <Wrapper>
        <Container>
          <InfoContainer>
            <Notice>
              <NoticeTitle>
                모든 버스는 곰상에서 2023/09/27 10:00 에 출발합니다.
              </NoticeTitle>
              <NoticeDesc>
                <p>· 계좌에 보증금 입금이 완료되어야 승차권 확정이 됩니다.</p>
                <p>
                  · <strong>승차권 신청/취소는 2023년 9월 20일 12시00분 기준으로 마감되었습니다.</strong>
                </p>
                <p>
                  · <strong>마감시간 이후 여행자보험 신청으로 인하여, 승차권 신청 및 취소는 절대 불가능 합니다.</strong>
                </p>
              </NoticeDesc>
            </Notice>
            <TicketInfo>
